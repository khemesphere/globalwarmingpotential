...
corn_savings <- emission_savings(time = 100, baseline_co2 = 958.8, baseline_co2sd = 657.3, co2 = -424, co2sd = 78.7, ch4 = 48-1.7, ch4sd = 6.9, type = "fe", runs = 1000)
pasture_savings <- emission_savings(time = 100, baseline_co2 = 305.7, baseline_co2sd = 78.7, co2 = -424, co2sd = 78.7, ch4 = 48-9.1, ch4sd = 6.9, type = "fe", runs = 1000)
alfalfa_savings <- emission_savings(time = 100, baseline_co2 = 411.02, baseline_co2sd = 236.4, co2 = -424, co2sd = 78.7, ch4 = 48-0.5, ch4sd = 6.9, type = "fe", runs = 1000)
...
c <- ggplot(alfalfa_savings) +
  ...
  geom_ribbon(aes(x = time, ymin = (net_mean - net_sd)/1000, ymax = (net_mean + net_sd)/1000), fill = "light grey" , alpha = 0.5) +
  geom_line(aes(x = time, y = net_mean/1000)) +
  geom_ribbon(aes(x = time, ymin = (co2base_cum - co2base_sd)/1000, ymax = (co2base_cum + co2base_sd)/1000), fill = "light green" , alpha = 0.5) +
  geom_line(aes(x = time, y = co2base_cum/1000), color = "green") + 
  ylab("CO2eq. budget (kg m-2)") + xlab("Time since restoration (years)") +
